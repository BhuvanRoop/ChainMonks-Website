    ...
    return (
        <>
            ...
            <main className="page-wrapper">
                ...
                <div className="slider-area slider-style-1 height-850 bg_image" data-black-overlay="6" style={{backgroundImage: `url(../../images/bg/ts-secretariat.png)`}}>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="inner pt-0 text-center">
                                    ...
                                    <h6 style={{color:'limegreen'}}>ChainMonks has a proven track record across multiple government departments and agencies.</h6>
                                    <h6 style={{color:'white'}}>We’ll help you build and implement innovative solutions to complex, public-sector challenges, including:</h6>
